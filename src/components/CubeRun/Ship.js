...
import { useStore, mutation } from '../../store/useStore'

const v = new Vector3()

function ShipModel(props, { children }) {
  const { nodes, materials } = useGLTF(shipModel, "https://www.gstatic.com/draco/v1/decoders/")
...
useGLTF.preload(shipModel, "https://www.gstatic.com/draco/v1/decoders/")
