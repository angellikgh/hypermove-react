...
const App = () => {
  ...
  return (
    <div className='App fw-light'>
      ...
      <OurAim/>
      <Container>
        <Row className="vh-100 align-items-center text-white justify-content-center text-center activities-group">
          <Col><MapBoxMap text="FIND ON MAP" className="dark-btn mb-4"/></Col>
          <Col><GameCard text="SCORE & WIN" className="dark-btn mb-4"/></Col>
          <Col><LeaderBoardCard text="LEADERBOARD" className="dark-btn mb-4"/></Col>
          <Col><MoveCard text="MOVE TO EARN"  className="dark-btn mb-4"/></Col>
